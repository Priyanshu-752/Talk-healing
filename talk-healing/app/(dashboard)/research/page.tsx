  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex flex-1 h-screen pt-[140px] md:pt-[90px] overflow-hidden">
        ...
        <div className="flex-1 px-4 py-6 md:pt[90px] md:px-0 md:py-6 md:ml-64 lg:ml-80 md:mr-64 lg:mr-10 overflow-y-auto space-y-7 scrollbar-none">
          <div className="bg-white rounded-2xl shadow-md p-3 flex flex-row gap-160">
