...
export default function LandingPage({ }) {
  return (
    <>
    <Header activeSection={''} setActiveSection={function (section: 'home' | 'community'): void {
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="mb-6">
            <div className="relative w-24 h-24 flex items-center justify-center">
              ...
              <div className="absolute inline-flex h-full w-full rounded-full bg-green-100 animate-pulse-shadow"></div>
              <svg className="relative w-12 h-12 text-green-500" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Link href="/get-started" className="inline-block px-8 py-3 rounded-full bg-green-500 text-white font-semibold text-lg transition-transform hover:scale-105 shadow-md hover:shadow-lg">
              Lorem
            </Link>
