    ...
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Share your thoughts and choose who can see your post.
          </DialogDescription>
        </DialogHeader>

        {/* Content below is OUTSIDE DialogDescription */}
        <div className="flex flex-col gap-2 mt-4">
          ...
          <Button
            ...
            onClick={onClose} // This just calls onClose; add your post-creation logic here if needed
          >
            Create
          </Button>
        </div>
